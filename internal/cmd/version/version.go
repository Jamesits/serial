...
func getVersionFullString() string {
	...
	return fmt.Sprintf("serial/%s (+https://github.com/Jamesits/serial; Compiled on %s for commit %s (%s) at %s)", getVersionNumberString(), versionCompileHost, versionGitCommitHash, versionGitStatus, versionCompileTime)
}
